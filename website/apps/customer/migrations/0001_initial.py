# Generated by Django 2.0.7 on 2018-08-12 11:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_wallet', models.IntegerField(choices=[(0, 'rial'), (1, 'dollar'), (2, 'euro')], default=0)),
                ('dest_wallet', models.IntegerField(choices=[(0, 'rial'), (1, 'dollar'), (2, 'euro')], default=0)),
                ('fianl_wallet', models.IntegerField(choices=[(0, 'rial'), (1, 'dollar'), (2, 'euro')], default=0)),
                ('amount', models.FloatField()),
                ('request_time', models.DateTimeField(auto_now_add=True)),
                ('description', models.CharField(max_length=500)),
                ('status', models.IntegerField(choices=[(0, 'accepted'), (1, 'rejected'), (2, 'pending'), (3, 'failed'), (4, 'reported')], default=2)),
        ...
        migrations.AddField(
            model_name='request',
            name='dest_user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='dest_user', to='main.Wallet_User'),
        ),
        migrations.AddField(
            model_name='request',
            name='final_user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='final_user', to='main.Wallet_User'),
        ),
        migrations.AddField(
            model_name='request',
        ...
        migrations.AddField(
            model_name='request',
            name='source_user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='source_user', to='main.Wallet_User'),
        ),
        migrations.CreateModel(
            name='IBT',
            fields=[
