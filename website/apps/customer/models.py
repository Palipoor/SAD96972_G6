...
class CustomTransactionType(models.Model):
    ...
    email1_exists = models.BooleanField(null=False, default=False)
    email2_exists = models.BooleanField(null=False, default=False)
    email3_exists = models.BooleanField(null=False, default=False)
    short_text1_exists = models.BooleanField(null=False, default=False)
    short_text2_exists = models.BooleanField(null=False, default=False)
    short_text3_exists = models.BooleanField(null=False, default=False)
    short_text4_exists = models.BooleanField(null=False, default=False)
    short_text5_exists = models.BooleanField(null=False, default=False)
    short_text6_exists = models.BooleanField(null=False, default=False)
    short_text7_exists = models.BooleanField(null=False, default=False)
    short_text8_exists = models.BooleanField(null=False, default=False)
    long_text1_exists = models.BooleanField(null=False, default=False)
    long_text2_exists = models.BooleanField(null=False, default=False)
    long_text3_exists = models.BooleanField(null=False, default=False)
    long_text4_exists = models.BooleanField(null=False, default=False)
    long_text5_exists = models.BooleanField(null=False, default=False)
    int1_exists = models.BooleanField(null=False, default=False)
    int2_exists = models.BooleanField(null=False, default=False)
    int3_exists = models.BooleanField(null=False, default=False)
    int4_exists = models.BooleanField(null=False, default=False)
    int5_exists = models.BooleanField(null=False, default=False)
    date1_exists = models.BooleanField(null=False, default=False)
    date2_exists = models.BooleanField(null=False, default=False)
    date3_exists = models.BooleanField(null=False, default=False)
    date4_exists = models.BooleanField(null=False, default=False)
    float1_exists = models.BooleanField(null=False, default=False)
    float2_exists = models.BooleanField(null=False, default=False)
    float3_exists = models.BooleanField(null=False, default=False)
    float4_exists = models.BooleanField(null=False, default=False)
    boolean1_exists = models.BooleanField(null=False, default=False)
    boolean2_exists = models.BooleanField(null=False, default=False)
    boolean3_exists = models.BooleanField(null=False, default=False)
    boolean4_exists = models.BooleanField(null=False, default=False)
    boolean5_exists = models.BooleanField(null=False, default=False)
    file1_exists = models.BooleanField(null=False, default=False)
    file2_exists = models.BooleanField(null=False, default=False)
    file3_exists = models.BooleanField(null=False, default=False)
    image1_exists = models.BooleanField(null=False, default=False)
    image2_exists = models.BooleanField(null=False, default=False)
    url1_exists = models.BooleanField(null=False, default=False)
    url2_exists = models.BooleanField(null=False, default=False)
    user1_exists = models.BooleanField(null=False, default=False)
    user2_exists = models.BooleanField(null=False, default=False)
    request1_exists = models.BooleanField(null=False, default=False)
    request2_exists = models.BooleanField(null=False, default=False)

    email1_label = models.CharField(max_length=100, null=True)
    email2_label = models.CharField(max_length=100, null=True)
    email3_label = models.CharField(max_length=100, null=True)
    short_text1_label = models.CharField(max_length=100, null=True)
    short_text2_label = models.CharField(max_length=100, null=True)
    short_text3_label = models.CharField(max_length=100, null=True)
    short_text4_label = models.CharField(max_length=100, null=True)
    short_text5_label = models.CharField(max_length=100, null=True)
    short_text6_label = models.CharField(max_length=100, null=True)
    short_text7_label = models.CharField(max_length=100, null=True)
    short_text8_label = models.CharField(max_length=100, null=True)
    long_text1_label = models.CharField(max_length=100, null=True)
    long_text2_label = models.CharField(max_length=100, null=True)
    long_text3_label = models.CharField(max_length=100, null=True)
    long_text4_label = models.CharField(max_length=100, null=True)
    long_text5_label = models.CharField(max_length=100, null=True)
    int1_label = models.CharField(max_length=100, null=True)
    int2_label = models.CharField(max_length=100, null=True)
    int3_label = models.CharField(max_length=100, null=True)
    int4_label = models.CharField(max_length=100, null=True)
    int5_label = models.CharField(max_length=100, null=True)
    date1_label = models.CharField(max_length=100, null=True)
    date2_label = models.CharField(max_length=100, null=True)
    date3_label = models.CharField(max_length=100, null=True)
    date4_label = models.CharField(max_length=100, null=True)
    float1_label = models.CharField(max_length=100, null=True)
    float2_label = models.CharField(max_length=100, null=True)
    float3_label = models.CharField(max_length=100, null=True)
    float4_label = models.CharField(max_length=100, null=True)
    boolean1_label = models.CharField(max_length=100, null=True)
    boolean2_label = models.CharField(max_length=100, null=True)
    boolean3_label = models.CharField(max_length=100, null=True)
    boolean4_label = models.CharField(max_length=100, null=True)
    boolean5_label = models.CharField(max_length=100, null=True)
    file1_label = models.CharField(max_length=100, null=True)
    file2_label = models.CharField(max_length=100, null=True)
    file3_label = models.CharField(max_length=100, null=True)
    image1_label = models.CharField(max_length=100, null=True)
    image2_label = models.CharField(max_length=100, null=True)
    url1_label = models.CharField(max_length=100, null=True)
    url2_label = models.CharField(max_length=100, null=True)
    user1_label = models.CharField(max_length=100, null=True)
    user2_label = models.CharField(max_length=100, null=True)
    request1_label = models.CharField(max_length=100, null=True)
    request2_label = models.CharField(max_length=100, null=True)
#
