...
def add_foreignTrans(apps, schema_editor):
    ...
    customer = Customer.objects.get(username='customer', email='customer@customer.com')
    foreignTrans = ForeignTrans(source_user=customer, creator=customer, source_wallet="0", amount=30000, account_number='12312412', bank_name='mammadbagherbank')
    customer.rial_credit -= 30000 + 3000 * foreignTrans.profitRate
    foreignTrans.save()
    foreignTrans = ForeignTrans(source_user=customer, creator=customer, source_wallet="1", amount=100, account_number='12312412', bank_name='mammadbagherbank')
    ...
    customer.dollar_cent_credit -= 100*(1*foreignTrans.profitRate)
    foreignTrans.save()
    foreignTrans = ForeignTrans(source_user=customer, creator=customer, source_wallet="2", amount=100, account_number='12312412', bank_name='mammadbagherbank')
