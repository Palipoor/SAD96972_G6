...
public class SignUp {
    ...
    /*
     * @Test public void preConditionTest() { // Initialize the WebDriver driver =
     * new ChromeDriver(); driver.manage().timeouts().implicitlyWait(100,
     * TimeUnit.SECONDS); //for checking already registered info
     * ProfileReusables.signUpUser1(driver); goToSignupPage(); String title =
     * driver.getTitle(); //assertEquals(title, ProfileReusables.SignUpTitle); }
     */
